    ...
    return (
        <>
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 hover:bg-gray-100 font-bold py-3 rounded-full transition-all transform hover:scale-[1.02] shadow-lg google-btn mb-3"
            ...
            <button
                type="button"
                onClick={() => useAuthStore.getState().loginWithZoho()}
                className="w-full flex items-center justify-center gap-3 bg-[#f5f5f5] text-gray-900 hover:bg-white font-bold py-3 rounded-full transition-all transform hover:scale-[1.02] shadow-lg zoho-btn"
                disabled={isFormDisabled}
            >
                <img src="/zoho-logo.png" alt="Zoho" className="w-6 h-6 object-contain" />
                Sign in with Zoho
            </button>
