...
ALTER TABLE IF EXISTS public.onboarding_submissions ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.attendance_approvals ENABLE ROW LEVEL SECURITY;
