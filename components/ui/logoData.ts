export const originalDefaultLogoBase64 =
...
export const getPdfLogoPath = (colorScheme: "green" | "blue") => {
    return colorScheme === "blue" ? southwallLogoPath : paradigmLogoPath;
};

// Helper function to get the organization name based on color scheme
export const getOrganizationName = (colorScheme: "green" | "blue") => {
    return colorScheme === "blue" ? "SouthWall Security" : "Paradigm Services";
};
