...
const MobileLayout: React.FC = () => {
    ...
    return (
        <div className={`flex flex-col min-h-screen ${colorScheme !== 'green' ? '!bg-slate-50' : '!bg-[#041b0f]'}`}>
            ...
            <main
                className={`flex-1 overflow-y-auto px-4 pt-2 ${colorScheme !== 'green' ? '!bg-slate-50' : '!bg-[#041b0f]'}`}
